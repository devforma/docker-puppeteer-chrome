...
const argsList = ["[\"xpath(//*[name()=\\\"MPD\\\"]/@mediaPresentationDuration | //*[name()=\\\"Period\\\"][starts-with(@id, \\\"Ad\\\")] | //*[name()=\\\"Period\\\"]/@start)\",\"Period[id^=\\\"Ad\\\"]\",\".mpd\"]","[\"xpath(//*[name()=\\\"Period\\\"][.//*[@value=\\\"Ad\\\"]] | //*[name()=\\\"Period\\\"]/@start)\",\"[value=\\\"Ad\\\"]\",\".mpd\"]","[\"xpath(//*[name()=\\\"MPD\\\"][.//*[name()=\\\"BaseURL\\\" and contains(text(),'dash_clear_fmp4')]]/@mediaPresentationDuration | //*[name()=\\\"Period\\\"][./*[name()=\\\"BaseURL\\\" and contains(text(),'dash_clear_fmp4')]])\",\"\",\".mpd\"]","[\"Period[id*=\\\"-roll-\\\"][id*=\\\"-ad-\\\"]\",\"\",\"pubads.g.doubleclick.net/ondemand\"]","[\"xpath(//*[name()=\\\"Period\\\"][not(.//*[name()=\\\"SegmentTimeline\\\"])])\",\"\",\".mpd\"]"];

const hostnamesMap = new Map([["hulu.com",0],["www.amazon.com",1],["go.discovery.com",2],["cbs.com",3],["paramountplus.com",3],["play.max.com",4]]);
...
for ( const i of todoIndices ) {
    try { xmlPrune(...JSON.parse(argsList[i])); }
    catch(ex) {}
}
argsList.length = 0;
