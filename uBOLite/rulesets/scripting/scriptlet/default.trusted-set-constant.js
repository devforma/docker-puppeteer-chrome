...
const argsList = ["[\"navigator.userAgent\",\"iPad; CPU OS 14_7_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.1.2 Mobile/15E148 Safari\"]","[\"navigator.platform\",\"iPhone\"]"];

const hostnamesMap = new Map([["app.blubank.com",0],["mobileweb.bankmellat.ir",[0,1]]]);
...
for ( const i of todoIndices ) {
    try { trustedSetConstant(...JSON.parse(argsList[i])); }
    catch(ex) {}
}
argsList.length = 0;
