...
const argsList = ["[\"seatbid rtb\"]","[\"rtb\"]","[\"rtb direct\"]","[\"*.blockId\"]","[\"ads\"]","[\"baits css direct *.slot\"]","[\"[].slot\"]","[\"result.body.direct\"]","[\"Blocks\"]","[\"auxiliaryUi.messageRenderers.enforcementMessageViewModel\"]"];

const hostnamesMap = new Map([["turbopages.org",3],["auto.ru",4],["otvet.mail.ru",5],["e.mail.ru",6],["octavius.mail.ru",6],["ok.ru",7],["championat.com",8],["youtube.com",9],["youtubekids.com",9],["youtube-nocookie.com",9]]);
