...
const argsList = ["[\"pum_vars\",\"undefined\"]","[\"searchDataFactory.rcmdPrdList\",\"{}\"]","[\"searchDataFactory.focusPrdList\",\"{}\"]","[\"searchDataFactory.powerPrdList\",\"{}\"]","[\"searchDataFactory.plusPrdList\",\"{}\"]","[\"player.renderAdSequence\",\"undefined\"]","[\"bannerpop.popup\",\"noopFunc\"]","[\"admode\",\"0\"]","[\"player.advertisement_finished\",\"true\"]","[\"reple_dori\",\"noopFunc\"]","[\"DANAWA_MOBILE_AD_MANAGER\",\"{}\"]","[\"getAdcrUrl\",\"\"]","[\"random_imglink\",\"noopFunc\"]","[\"vrixadsdk\",\"undefined\"]","[\"PartnersCoupang\",\"undefined\"]","[\"adsBlocked\",\"noopFunc\"]","[\"DHAntiAdBlocker\",\"true\"]","[\"checkAds\",\"noopFunc\"]"];

const hostnamesMap = new Map([["333aaa.site",0],["search.11st.co.kr",[1,2,3,4]],["sbs.co.kr",5],["domin.co.kr",6],["uwayapply.com",7],["tvchosun.com",8],["m.dcinside.com",9],["m.danawa.com",10],["naver.com",11],["koreapas.com",12],["imbc.com",13],["meeco.kr",15],["sogirl.so",16],["tistory.com",17],["sajuplus.net",17]]);

const entitiesMap = new Map([]);

const exceptionsMap = new Map([["coupang.com",[14]],["coupangcdn.com",[14]]]);
